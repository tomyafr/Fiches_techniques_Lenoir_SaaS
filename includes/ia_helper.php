...
function extractIssuesFromDonnees($donnees) {
    $labelsMap = [
        ...
        // SEPARATEUR A GRILLE SGCP/SGCM
        'sgcp_satisfaction' => 'Satisfaction de fonctionnement',
        'sgcp_aspect' => 'Aspect général',
        'sgcp_f' => 'Fréquence de nettoyage',
        'sgcp_produit_stat' => 'Type de produit',
        'sgcp_granulo_stat' => 'Granulométrie',
        'sgcp_debit_stat' => 'Débit',
        'sgcp_atex_stat' => 'Environnement Atex',
        'sgcp_e1_stat' => 'Étage 1 - barreaux',
        'sgcp_e1_coulissement' => 'Étage 1 - coulissement',
        'sgcp_e1_etancheite' => 'Étage 1 - étanchéité',
        'sgcp_e2_stat' => 'Étage 2 - barreaux',
        'sgcp_e2_coulissement' => 'Étage 2 - coulissement',
        'sgcp_e2_etancheite' => 'Étage 2 - étanchéité',
