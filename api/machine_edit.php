...
4. Être factuel, précis et professionnel (style industriel).
...
- SGA / SGSA / SGCP : Séparateur à grilles
...
7. Style : impersonnel, factuel, professionnel. Pas de recommandations. Pas de \"nous conseillons\".";
        ...
        $userPrompt .= "DÉTAILS DES ANOMALIES :\n" . ($allIssuesString ?: "Néant") . "\n\n";
            ...
            <div class="pdf-page" style="page-break-before: always;">
                    ...
                    <table class="pdf-table controles" style="font-size:11px; margin-top:0;">
                        ...
                        <tbody>
                            ...
                            <?php for($e=1; $e<=2; $e++): ?>
                                ...
                                <?= renderAprfRow("Étanchéité du tiroir à la fermeture", "sgcp_e".$e."_etancheite", $donnees) ?>
                            <?php endfor; ?>
                                ...
                                <tr>
                                    <td style="padding:8px; vertical-align:top;">
                                        ...
                                        <?php 
                                            ...
                                            // Par défaut, si non défini, on montre au moins ce qui est déjà rempli
                                            if ($nbB_sgsa <= 0) {
                ...
                <?php elseif ($isSGA): ?>
                    ...
                    <table class="pdf-table controles" style="font-size:11px; margin-top:0;">
                        ...
                        <tbody>
                            ...
                            <?= renderAprfRow("Étanchéité sous coffret", "sga_etanch_coffret", $donnees) ?>
                ...
                <?php elseif ($isSPM): ?>
                    ...
                    <table class="pdf-table controles" style="font-size:11px; margin-top:0;">
                        ...
                        <tbody>
                            ...
                            <?= renderAprfRow("Étanchéité des plaques", "spm_etanch_plaques", $donnees) ?>
                            <?= renderAprfRow("Étanchéité des brides", "spm_etanch_brides", $donnees) ?>
                ...
                <?php elseif ($isLevage): ?>
                    ...
                    <?php else: ?>
                        ...
                        if ($foundSchema):
                            ?>
                            <?php if(!$titleB_printed){ echo '<div style="page-break-inside:avoid; break-inside:avoid;"><div class="pdf-section-title" style="margin-top:20px; text-align:left;">B) DESCRIPTION DU MATÉRIEL :</div>'; $titleB_printed = true; $closeFallbackTitle = true; } else { $closeFallbackTitle = false; } ?>
                        ...
                        <div class="section-wrapper-pdf" style="padding:0; background: transparent; page-break-inside: avoid; break-inside: avoid;">
                            ...
                            <?php if (!isset($_GET['pdf'])): ?>
                                ...
                                <button type="button" class="btn-ia-action" onclick="generateDysfunctions(this)" style="margin-top:5px; background:#2980b9; color:white; border:none; padding:5px 10px; border-radius:4px; cursor:pointer; font-size:11px;">
                                    <img src="/assets/ai_expert.jpg" style="height: 14px; width: 14px; vertical-align: middle; margin-right: 4px; mix-blend-mode: screen;"> Actualiser
                                </button>
                            <?php else: ?>
                                <?php 
