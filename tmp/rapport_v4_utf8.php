...
<head>
    ...
    <style>
        .rapport-page { margin-top: 10px; }

        /* V4.0 PROGRESS BAR */
        #pdf-progress-container {
            position: fixed; top: 0; left: 0; width: 100%; height: 5px; background: rgba(0,0,0,0.1); z-index: 10000; display: none;
        }
        #pdf-progress-bar {
            height: 100%; width: 0%; background: linear-gradient(90deg, #f1b017, #f39c12); transition: width 0.3s;
        }
...
<body>
    <div id="pdf-progress-container"><div id="pdf-progress-bar"></div></div>
    ...
    <div class="rapport-page">
        <form method="POST" id="rapportForm" autocomplete="off">
                ...
                <div id="successBanner"
                    ...
                    <div style="display:flex; gap:0.75rem; justify-content:center; flex-wrap:wrap;">
                        ...
                        <button type="button" id="btnDownloadPDF" onclick="telechargerPDF()"
                            ...
                            <span id="btnDownloadPDFLabel">T├®l├®charger le PDF (V4.0 Ultra-Stabilit├®)</span>
                        </button>
            ...
            <button type="submit" class="btn-final" onclick="return validateAndSubmit()">
                T├®l├®charger le rapport final (V4.0 Ultra-Stability)
            </button>
