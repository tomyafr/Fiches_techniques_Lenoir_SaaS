    ...
    foreach ($donnees as $k => $v) {
        if (strpos($k, '_radio') !== false || strpos($k, '_stat') !== false || 
            ...
            if (!empty($v) && $v !== 'pc') {
                ...
                elseif ($v === 'aa' || $v === 'r' || $v === 'A amÃ©liorer') $totalAmeliorer++;
...
<body>
    ...
    <div class="rapport-page">
        <form method="POST" id="rapportForm">
            ...
            <?php if (isset($_GET['msg']) && $_GET['msg'] === 'ok'): ?>
                <div id="successBanner"
                    ...
                    <div style="background: rgba(0,0,0,0.1); border: 1px solid rgba(255,255,255,0.1); padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem; text-align: left;">
                        <div style="font-weight: 700; color: #f59e0b; margin-bottom: 0.5rem;">âš ï¸ <?= $nbMachinesEmpty ?> fiche(s) non remplie(s) dÃ©tectÃ©e(s)</div>
                        ...
                        <label style="display: block; font-size: 0.85rem; cursor: pointer; color: var(--text);">
                            ...
                            Les inclure en version condensÃ©e (1 page "Non contrÃ´lÃ©")
                        </label>
                    </div>
                    <?php endif; ?>
                    ...
                    <div style="display:flex; gap:0.75rem; justify-content:center; flex-wrap:wrap;">
                        ...
                        <button type="button" id="btnSendEmail" onclick="lancerEnvoiEmail()"
                            ...
                            <span id="btnSendEmailIcon">ðŸ“§</span>
            ...
            <!-- RÃ‰CAP MACHINES -->
            <div class="section-title">Ã‰quipements contrÃ´lÃ©s (
                <?= count($machines) ?>)
            </div>
                ...
                <?php foreach ($machines as $m): ?>
                    ...
                    <span class="machine-tag" style="border-left: 4px solid <?= $statusColor ?>;">
                        ...
                        <?php if (!empty($mm['repere'])): ?>
                            <small style="opacity:0.7">â€“ <?= htmlspecialchars($mm['repere']) ?></small>
                        <?php endif; ?>
            ...
            <div class="card glass" style="padding: 1.5rem;">
                ...
                <div class="field-row">
                    <div class="form-group">
                        <label class="label">Nom et PrÃ©nom du contact <span style="color:var(--error);">*</span></label>
                        <input type="text" name="contact_nom" id="contact_nom" class="input" placeholder="Nom et prÃ©nom..."
                        ...
                        <small id="contact_nom_warning" style="color: var(--error); display: none; font-size: 0.75rem; margin-top: 0.25rem;">
                            âš ï¸ Attention: CaractÃ¨res rÃ©pÃ©tÃ©s dÃ©tectÃ©s.
                        </small>
                    </div>
                    <div class="form-group">
